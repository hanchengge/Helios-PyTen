import os
import Helios,Helios1,Helios2,Helios3
from Tkinter import *
...
class TensorUI:
    ...
    def submitClick(self):
        if self.selectedScenario == self.scenarios[0]:
            value='1'
            Helios1.Helios1(self.file_path,self.methodsValue[self.selectedMethod], self.op.get())
        elif self.selectedScenario == self.scenarios[1]:
            value='2'
            Helios2.Helios2(self.file_path,self.methodsValue[self.selectedMethod], self.op.get())
        else:
            value='3'
            Helios3.Helios3(self.file_path,self.methodsValue[self.selectedMethod], self.op.get())
