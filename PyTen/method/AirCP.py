...
class AirCP(object):
    ...
    def __init__(self, obser, omega=None, rank=20, tol=1e-5, maxIter=500, simMats=None, alpha=None, lmbda=None, eta=1e-4, rho=1.05):
        if not obser:
    ...
    def run(self):
        ...
        for k in range(self.maxIter):
            if k%20 == 1:
                print 'AirCP: iterations={0}, difference={1}'.format(k, self.errList[-1])
