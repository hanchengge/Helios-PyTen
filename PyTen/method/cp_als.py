...
from PyTen.tenclass import ktensor


def cp_als(Y,R=20,Omega=None,tol=1e-4,maxiter=50,init='random',printitn=1):
    ...
    for iter in range(1,maxiters+1):
        ...
        for n in range(N):
            ...
            Unew=Xn.dot(khatrirao.khatrirao(tempU));
